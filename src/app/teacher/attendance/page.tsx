...
import { ClipboardCheck, Calendar, Users, ChevronRight, Activity, Clock, MoreVertical, FileText } from "lucide-react";
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex bg-white p-1 rounded-2xl border border-slate-100 shadow-sm">
            <button className="px-6 py-2 bg-indigo-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-indigo-100 transition-all">My Records</button>
            <button className="px-6 py-2 text-slate-400 hover:text-slate-600 transition-all rounded-xl text-[10px] font-black uppercase tracking-widest">Global Archives</button>
        </div>
      </div>
